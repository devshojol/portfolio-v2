    ...
    <DragAble>
      <HoverEffect onclick={onclick}>
        <div className="group relative">
          <motion.div
            className={cn(
              'relative h-21 w-25 rounded-tr-xl rounded-b-xl bg-[#03596E] before:content-[""] after:absolute after:-top-3.5 after:left-0 after:z-0 after:h-4 after:w-15 after:rounded-tl-xl after:rounded-tr-2xl after:bg-[#03596E] after:content-[""]',
              className
            )}
          >
